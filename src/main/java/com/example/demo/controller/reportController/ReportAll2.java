package com.example.demo.controller.reportController;
...
@WebServlet(value = "/total2")
public class ReportAll2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            req.getRequestDispatcher("total2.jsp").forward(req, resp);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
