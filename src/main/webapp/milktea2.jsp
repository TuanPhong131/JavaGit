...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="/demo_war_exploded/milktea2">Milktea</a></li>
...
<div class="container-fluid" style="margin-left: 50px">
    ...
    <div class="col-sm-6">
        <a href="addMilktea2.jsp"><i
                class="material-icons">&#xE147;</i> <span>Add New Item</span></a>

        <a href="/demo_war_exploded/salesMilktea2"><i
...
<div class="container">
    <table class="table table-striped">
        ...
        <form action="/milktea2" method="get">
            <tbody>
        ...
        <form action="/searchMilktea2" method="get">
            <tbody>
...
<script>
    function DeleteFunction(id) {
        $.ajax({
            url: '/demo_war_exploded/milktea2?sid=' + id,
            dataType: 'text',
            type: 'DELETE',
            async: true,
            statusCode: {
...
<script>
    function SelectFunction(id) {
        $.ajax({
            url: '/demo_war_exploded/updateMilktea2?sid=' + id,
            dataType: 'text',
            type: 'GET',
            async: true,
            statusCode: {
                ...
                200: function (response) {
                    window.location.href = '/demo_war_exploded/updateMilktea2?sid=' + id
                }
            },
            error: function (jqXHR, status, errorThrown) {
                alert('error');
