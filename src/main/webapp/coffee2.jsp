...
<div class="container-fluid" style="margin-left: 50px">
    ...
    <div class="col-sm-6">
        <a href="addCoffee2.jsp"><i
                class="material-icons">&#xE147;</i> <span>Add New Item</span></a>
        <a href="/demo_war_exploded/salesCoffee2"><i
                class="material-icons">&#xE147;</i> <span>Report Sales</span></a>
        <form class="navbar-form navbar-right" action="searchCoffee2" method="get">
...
<div class="container">
    <table class="table table-striped">
        ...
        <form action="/coffee2" method="get">
            <tbody>
        ...
        <form action="/searchCoffee2" method="get">
            <tbody>
...
<script>
    function DeleteFunction(id) {
        $.ajax({
            url: '/demo_war_exploded/coffee2?sid=' + id,
            dataType: 'text',
            type: 'DELETE',
            async: true,
            statusCode: {
...
<script>
    function SelectFunction(id) {
        $.ajax({
            url: '/demo_war_exploded/updateCoffee2?sid=' + id,
            dataType: 'text',
            type: 'GET',
            async: true,
            statusCode: {
                ...
                200: function (response) {
                    window.location.href = '/demo_war_exploded/updateCoffee2?sid=' + id
                }
            },
            error: function (jqXHR, status, errorThrown) {
                alert('error');
